...
namespace Suplex.Data
{
    ...
    public class SqlDataAccessor : ISqlDataAccessor
    {
        ...
        /// <summary>
        /// Get/Set the wait time before terminating the attempt to execute a command and generating an error.
        /// </summary>
        [Description( "Get/Set the wait time before terminating the attempt to execute a command and generating an error." )]
